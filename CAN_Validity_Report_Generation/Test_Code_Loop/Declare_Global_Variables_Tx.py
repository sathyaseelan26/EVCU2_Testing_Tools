#To Declare Global Variables in files Tx
import os
import pandas as pd
...
#os.chdir(wrkng_dir)
Global_Variables_to_be_declared = pd.read_excel('Global_Variables_to_be_declared_Tx.xlsx')
...
Global_Variables_to_be_declared.to_excel('Global_Variables_to_be_declared_sorted_Tx.xlsx',engine = 'xlsxwriter',index = False)
