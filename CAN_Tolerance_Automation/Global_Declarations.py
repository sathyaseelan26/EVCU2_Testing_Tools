...
def init_Test_Mapping_Sheets(Test_Mapping_Sheets_Folder):
    for file in listdir(Test_Mapping_Sheets_Folder):
        if ".xlsx" in file:
            if ("FD3" in file or "FDCAN3" in file) and Mapping_Sheets["FD3"] != "":
                Test_Mapping_Sheets["FD3"] = file
            elif ("FD5" in file or "FDCAN5" in file) and Mapping_Sheets["FD5"] != "":
                Test_Mapping_Sheets["FD5"] = file
            elif ("FD11" in file or "FDCAN11" in file) and Mapping_Sheets["FD11"] != "":
                Test_Mapping_Sheets["FD11"] = file
            elif ("FD14" in file or "FDCAN14" in file) and Mapping_Sheets["FD14"] != "":
                Test_Mapping_Sheets["FD14"] = file
            elif ("FD16" in file or "FDCAN16" in file) and Mapping_Sheets["FD16"] != "":
