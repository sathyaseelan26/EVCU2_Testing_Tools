...
#ifndef HIGHLEVELCTRL_BEV_H
#define HIGHLEVELCTRL_BEV_H
...
extern INTERMEDIATE uint8 ApplBev_idxTsk;
...
extern void HLevCtrlBev(void);

#endif /* HIGHLEVELCTRL_BEV_H */
/*----------------------------------------------------------------------------*\
  END OF FILE
\*----------------------------------------------------------------------------*/
