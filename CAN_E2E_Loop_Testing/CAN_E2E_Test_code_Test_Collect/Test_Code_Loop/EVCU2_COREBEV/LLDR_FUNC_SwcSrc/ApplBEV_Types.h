...
#ifndef APPLBEV_TYPES_H
#define APPLBEV_TYPES_H
...
#ifndef t_frontMotor_TYPE
#define t_frontMotor_TYPE
typedef boolean t_frontMotor; /* MIN/MAX: 0 .. 1 */
#endif /* t_frontMotor_TYPE */
