...
uint8 VeCANR_e_Remote_Chargeport_Cmnd_APMR_ac_Test_1;
boolean VeCANR_b_Submit_ClimateSchd2_APMR_ac_Test_1;
boolean VeCANR_b_TBM_Submit_Schedule1_APMR_ac_Test_1;
uint8 VeCANR_e_TBMCooperativeChrgCmnd_APMR_ac_Test_1;
...
VeCANR_e_Remote_Chargeport_Cmnd_APMR_ac_Test_1 = tmpRead_c;
...
VeCANR_e_TBMCooperativeChrgCmnd_APMR_ac_Test_1 = tmpRead_d;
