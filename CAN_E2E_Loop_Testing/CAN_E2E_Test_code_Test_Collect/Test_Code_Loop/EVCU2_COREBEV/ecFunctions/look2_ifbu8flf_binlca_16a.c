/*
 * File: look2_ifbu8flf_binlca_16a.c
 *
...
float32 look2_ifbu8flf_binlca_16a(float32 u0, float32 u1, const uint8 bp0[],
    ...
    uint32 stride)
{
    ...
    /* Column-major Lookup 2-D
       Canonical function name: look2_ifbu8flf_binlca
    ...
    else if (u0 < ((float32)bp0[maxIndex[0U]]))
    {
        ...
        frac = (u0 - ((float32)bp0[iLeft])) / ((float32)((uint8)(((uint32)
            bp0[iLeft + 1U]) - ((uint32)bp0[iLeft]))));
    }
    else
    {
        iLeft = maxIndex[0U];
