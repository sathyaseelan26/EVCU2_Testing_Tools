...
def add_Test_Variable(final_path,port_name,file_name):
    ...
    with open(final_path,"r+") as source_code, open(final_path+".edited","w") as edited_code:
        ...
        for line in source_code:
            ...
            if (((port_name + "_" + "E2ECheckSts") in line and "Rte_Read_" in line) or (next_line_req == 1)):
...
#print(df)
df.to_excel('Global_Variables_declared_E2E_Check_Status.xlsx',engine = 'xlsxwriter',index = False)
# os.chdir(wrkng_dir)