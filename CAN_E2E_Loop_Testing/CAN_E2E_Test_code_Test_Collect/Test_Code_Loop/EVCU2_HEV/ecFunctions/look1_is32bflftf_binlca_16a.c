/*
 * File: look1_is32bflftf_binlca_16a.c
 *
...
float32 look1_is32bflftf_binlca_16a(sint32 u0, const float32 bp0[], const
    float32 table[], uint32 maxIndex)
{
    ...
    /* Column-major Lookup 1-D
       Canonical function name: look1_is32bflftf_binlca
