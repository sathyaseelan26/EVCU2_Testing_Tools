...
public static void Test_Case_SendCANR_Motor1_RPM_CT3B_BLUEN_ac_Test_1(Test_MSExcel_Report report)
{
	...
	T32_CSharp_API.WriteVariableValue("SendCANR_Motor1_RPM_CT3B_BLUEN_ac_Test_1","-32768.0");
	Execution.Wait(2500);
	...
	Temp_Input_Value = -3806.0;
	Report.TestCaseComment("Modifying the value to " + Temp_Input_Value);
	T32_CSharp_API.WriteVariableValue("SendCANR_Motor1_RPM_CT3B_BLUEN_ac_Test_1","-3806.0");
	Execution.Wait(2500);
	Temp_Actual_Value = NetworkDB.FD14.EVCU2.HYBRID_POWERTRAIN6.Motor1_RPM.Value;
	Test_Input_Values = Test_Input_Values + "Input Test Data: " + Temp_Input_Value + "\n";
	Test_Actual_Values = Test_Actual_Values + "Actual Data: " + Temp_Actual_Value + "\n";
	...
	Report.TestCaseComment("Modifying the value to " + Temp_Input_Value);
	T32_CSharp_API.WriteVariableValue("SendCANR_Motor1_RPM_CT3B_BLUEN_ac_Test_1","32767.0");
	Execution.Wait(2500);
	Temp_Actual_Value = NetworkDB.FD14.EVCU2.HYBRID_POWERTRAIN6.Motor1_RPM.Value;
	Test_Input_Values = Test_Input_Values + "Input Test Data: " + Temp_Input_Value + "\n";
	Test_Actual_Values = Test_Actual_Values + "Actual Data: " + Temp_Actual_Value + "\n";
...
public static void Test_Case_SendCANR_Motor2_RPM_CT3B_BLUEN_ac_Test_1(Test_MSExcel_Report report)
{
	...
	Temp_Input_Value = -32768.0;
	Report.TestCaseComment("Modifying the value to " + Temp_Input_Value);
	T32_CSharp_API.WriteVariableValue("SendCANR_Motor2_RPM_CT3B_BLUEN_ac_Test_1","-32768.0");
	Execution.Wait(2500);
	...
	Temp_Input_Value = 20179.0;
	Report.TestCaseComment("Modifying the value to " + Temp_Input_Value);
	T32_CSharp_API.WriteVariableValue("SendCANR_Motor2_RPM_CT3B_BLUEN_ac_Test_1","20179.0");
	Execution.Wait(2500);
	Temp_Actual_Value = NetworkDB.FD14.EVCU2.HYBRID_POWERTRAIN6.Motor2_RPM.Value;
	Test_Input_Values = Test_Input_Values + "Input Test Data: " + Temp_Input_Value + "\n";
	Test_Actual_Values = Test_Actual_Values + "Actual Data: " + Temp_Actual_Value + "\n";
	...
	Temp_Input_Value = 32767.0;
	Report.TestCaseComment("Modifying the value to " + Temp_Input_Value);
	T32_CSharp_API.WriteVariableValue("SendCANR_Motor2_RPM_CT3B_BLUEN_ac_Test_1","32767.0");
	Execution.Wait(2500);
	Temp_Actual_Value = NetworkDB.FD14.EVCU2.HYBRID_POWERTRAIN6.Motor2_RPM.Value;
	Test_Input_Values = Test_Input_Values + "Input Test Data: " + Temp_Input_Value + "\n";
	Test_Actual_Values = Test_Actual_Values + "Actual Data: " + Temp_Actual_Value + "\n";
...
public static void Automated_Tx_Testing_FD14()
{
	...
	Test_Case_SendCANR_Motor1_RPM_CT3B_BLUEN_ac_Test_1(report);
	Test_Case_SendCANR_Motor2_RPM_CT3B_BLUEN_ac_Test_1(report);
