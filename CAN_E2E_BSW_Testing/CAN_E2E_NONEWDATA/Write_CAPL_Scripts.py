...
def Write_CAPL(Board,message,FD_Channel,DLC,CRC_Start_Bit,Message_Counter_Start_Bit):
    ...
    with open(OutputFiles + "/" + "CAPL_Scripts" + "/" + Board + "/" + FD_Channel + "/" + message + ".can", "w") as f:
