...
from Create_Test_Cases import Create_Test_Cases_Tx,Create_Test_Cases_Rx , Create_Test_Cases_Invalid_Rx
...
def main():
    ...
    while True:
        user_inp = input("\nPlease enter the Task to be executed:\n\t1) Write Test Code - Tx\n\t2) Write Test Code - Rx\n\t3) Create Test Cases for VTestStudio - Tx\n\t4) Create Test Cases for VTestStudio - Rx\n\t5)Test case generation for invalidity Keep signals\n\t 6) Exit\nYour Input: ")
        ...
        if int(user_inp) == 1:
            ...
            Create_Test_Cases_Invalid_Rx(Board,DBC_Folder)
