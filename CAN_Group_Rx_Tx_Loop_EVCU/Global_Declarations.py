...
def  init_Mapping_Sheets(Mapping_Sheets_Folder,Board):
    if Board.upper() == "EDM_MCPA":
        for file in listdir(Mapping_Sheets_Folder):
            if file.endswith(".xlsx") and "MCPA" in file:
                if "FD5" in file or "FDCAN5" in file:
                    Mapping_Sheets["FD5"] = file
                elif "FD16" in file or "FDCAN16" in file:
                    Mapping_Sheets["FD16"] = file
    elif Board.upper() == "EDM_MCPB":
        for file in listdir(Mapping_Sheets_Folder):
            if file.endswith(".xlsx") and "MCPB" in file:
                if "FD5" in file or "FDCAN5" in file:
                    Mapping_Sheets["FD5"] = file
                elif "FD16" in file or "FDCAN16" in file:
                    Mapping_Sheets["FD16"] = file
        ...
        for file in listdir(Mapping_Sheets_Folder):
            if file.endswith(".xlsx") and "SGCP" in file:
                if "FD5" in file or "FDCAN5" in file:
                    Mapping_Sheets["FD5"] = file
                elif "FD16" in file or "FDCAN16" in file:
                    Mapping_Sheets["FD16"] = file
...
def init_Test_Mapping_Sheets(Test_Mapping_Sheets_Folder, Board):
    if Board.upper() == "EDM_MCPA":
