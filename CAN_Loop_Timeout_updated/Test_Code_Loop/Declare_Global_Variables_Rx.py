...
def  Declare_Global_Variables(Global_Variables_to_be_declared,File_Name,curr_ind):
    ...
    while (Global_Variables_to_be_declared.at[i,"File Name"] == File_Name):
        ...
        Declaration = Declaration + "boolean" + " " + Global_Variables_to_be_declared.at[i,"Global Variable"] + ";\n"
        i = i+1
...
#os.chdir(wrkng_dir)
Global_Variables_to_be_declared = pd.read_excel('Global_Variables_to_be_declared_Rx.xlsx')
